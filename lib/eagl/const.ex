defmodule EAGL.Const do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      @gl_rg_integer 33320  # GL_RG_INTEGER
      ...
      @gl_r8 33321  # GL_R8
      @gl_r8_snorm 36756  # GL_R8_SNORM
      @gl_r16 33322  # GL_R16
      @gl_r16_snorm 36760  # GL_R16_SNORM
      @gl_rg8 33323  # GL_RG8
      @gl_rg8_snorm 36757  # GL_RG8_SNORM
      @gl_rg16 33324  # GL_RG16
      @gl_rg16_snorm 36761  # GL_RG16_SNORM
      @gl_r3_g3_b2 10768  # GL_R3_G3_B2
      @gl_rgb4 32847  # GL_RGB4
      @gl_rgb5 32848  # GL_RGB5
      @gl_rgb8 32849  # GL_RGB8
      @gl_rgb8_snorm 36758  # GL_RGB8_SNORM
      @gl_rgb10 32850  # GL_RGB10
      @gl_rgb12 32851  # GL_RGB12
      @gl_rgb16 32852  # GL_RGB16
      @gl_rgb16_snorm 36762  # GL_RGB16_SNORM
      @gl_rgba2 32853  # GL_RGBA2
      @gl_rgba4 32854  # GL_RGBA4
      @gl_rgb5_a1 32855  # GL_RGB5_A1
      @gl_rgba8 32856  # GL_RGBA8
      @gl_rgba8_snorm 36759  # GL_RGBA8_SNORM
      @gl_rgb10_a2 32857  # GL_RGB10_A2
      @gl_rgb10_a2ui 36975  # GL_RGB10_A2UI
      @gl_rgba12 32858  # GL_RGBA12
      @gl_rgba16 32859  # GL_RGBA16
      @gl_rgba16_snorm 36763  # GL_RGBA16_SNORM
      ...
      @gl_r11f_g11f_b10f 35898  # GL_R11F_G11F_B10F
      @gl_rgb9_e5 35901  # GL_RGB9_E5
      ...
      @gl_r8i 33329  # GL_R8I
      @gl_r8ui 33330  # GL_R8UI
      @gl_r16i 33331  # GL_R16I
      @gl_r16ui 33332  # GL_R16UI
      @gl_r32i 33333  # GL_R32I
      @gl_r32ui 33334  # GL_R32UI
      @gl_rg8i 33335  # GL_RG8I
      @gl_rg8ui 33336  # GL_RG8UI
      @gl_rg16i 33337  # GL_RG16I
      @gl_rg16ui 33338  # GL_RG16UI
      @gl_rg32i 33339  # GL_RG32I
      @gl_rg32ui 33340  # GL_RG32UI
      @gl_rgb8i 36239  # GL_RGB8I
      @gl_rgb8ui 36221  # GL_RGB8UI
      @gl_rgb16i 36233  # GL_RGB16I
      @gl_rgb16ui 36215  # GL_RGB16UI
      @gl_rgb32i 36227  # GL_RGB32I
      @gl_rgb32ui 36209  # GL_RGB32UI
      @gl_rgba8i 36238  # GL_RGBA8I
      @gl_rgba8ui 36220  # GL_RGBA8UI
      @gl_rgba16i 36232  # GL_RGBA16I
      @gl_rgba16ui 36214  # GL_RGBA16UI
      @gl_rgba32i 36226  # GL_RGBA32I
      @gl_rgba32ui 36208  # GL_RGBA32UI
      ...
      @gl_stencil_index 6401  # GL_STENCIL_INDEX
      @gl_stencil_index1 36166  # GL_STENCIL_INDEX1
      @gl_stencil_index4 36167  # GL_STENCIL_INDEX4
      @gl_stencil_index8 36168  # GL_STENCIL_INDEX8
      @gl_stencil_index16 36169  # GL_STENCIL_INDEX16

      # ============================================================================
      # COMPRESSED FORMATS
      # ============================================================================

      @gl_compressed_red 33317  # GL_COMPRESSED_RED
      @gl_compressed_rg 33318  # GL_COMPRESSED_RG
      @gl_compressed_rgb 34029  # GL_COMPRESSED_RGB
      @gl_compressed_rgba 34030  # GL_COMPRESSED_RGBA
      @gl_compressed_srgb 35912  # GL_COMPRESSED_SRGB
      @gl_compressed_srgb_alpha 35913  # GL_COMPRESSED_SRGB_ALPHA
      ...
      @gl_src1_color 35065  # GL_SRC1_COLOR
      @gl_one_minus_src1_color 35066  # GL_ONE_MINUS_SRC1_COLOR
      @gl_src1_alpha 34185  # GL_SRC1_ALPHA
      @gl_one_minus_src1_alpha 35067  # GL_ONE_MINUS_SRC1_ALPHA
      ...
      @gl_polygon_smooth 2881  # GL_POLYGON_SMOOTH
